...
import { ArrowRight, Lock, Mail, User as UserIcon, AlertCircle, CheckCircle } from "lucide-react";
        ...
        <Card className="border-border/80 shadow-xl bg-card/95 backdrop-blur-md">
          <CardHeader className="space-y-1 text-left pb-4">
            ...
            <CardDescription className="text-xs">
              No credit card required. Free tier includes 10,000 transaction rows.
            </CardDescription>
          </CardHeader>
